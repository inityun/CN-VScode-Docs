...
module.exports = {
    ...
    hooks: {
        finish: function () {
            var configOption = this.config.get('pluginsConfig')['theme-hqbook'];
            var output = configOption ? (configOption.output || 'public') : 'public';
            var pathFile;
            ...
            if(pathFile){
                ...
                var pluginLogoPath = path.join(process.cwd(), output, 'gitbook','gitbook-plugin-theme-hqbook',"logo.png");
