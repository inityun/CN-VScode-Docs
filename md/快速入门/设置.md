...
You can also open the user and workspace settings from the **Command Palette** (`⇧⌘P`) with **Preferences: Open User Settings** and **Preferences: Open Workspace Settings** or use the keyboard shortcut (`⌘,`).
...
![Example Settings](/images/2023-04-11-14-45-15.png)
...
![Settings Groups](/images/2023-04-11-14-48-09.png)

Here is the [copy of default settings](/md/快速入门/设置.md#copy-of-default-settings) that comes with VS Code.
...
![Configure language specific settings command](/images/2023-04-11-14-57-37.png)

![Select language drop down](/images/2023-04-11-14-58-03.png)

![Add language specific setting](/images/2023-04-11-14-58-29.png)
