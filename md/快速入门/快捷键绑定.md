...
![Keyboard Shortcuts](https://code.visualstudio.com/assets/docs/getstarted/keybinding/keyboard-shortcuts.gif)
...
![show keybinding conflicts menu](https://code.visualstudio.com/assets/docs/getstarted/keybinding/show-conflicts-menu.png)
...
![show keybinding conflicts result](https://code.visualstudio.com/assets/docs/getstarted/keybinding/show-conflicts-result.png)
...
![render key binding](https://code.visualstudio.com/assets/docs/getstarted/keybinding/render-key-binding.png)
...
![keybindings.json guidance](https://code.visualstudio.com/assets/docs/getstarted/keybinding/keybindings-json.png)
...
![key binding widget](https://code.visualstudio.com/assets/docs/getstarted/keybinding/key-binding-widget.png)
...
![Key bindings quick outline](https://code.visualstudio.com/assets/docs/getstarted/keybinding/outline.png)
