...
Keyboard Shortcut: `kb(workbench.action.focusFirstEditorGroup)`, `ctrl+2`, `Ctrl+3`
...
Navigate through diffs with `kb(editor.action.diffReview.next)` and `shift+f7`. This will present them in a unified patch format.
