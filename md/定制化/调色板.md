...
颜色、图标主题、片段和语法高亮的自定义调色板可以给编辑器以生命力。已经存在大量可用的TextMate自定义文件，并且VS Code让你可以轻易的打包和重用它们。你可以直接使用扩展名为`.tmTheme`、`.tmSnippets`和`.tmLanguage`的文件，也可以在扩展[市场](https://marketplace.visualstudio.com/VSCode)中分享你的主题。 这个标题描述了如何重用TextMate的文件，以及如何创建或分享你自己的主题、片段和调色板。
...
- Open the [settings](/md/快速入门/设置.md) and make changes to view and editor colors using the `workbench.colorCustomizations`. Changes are applied live to your VS Code instance and no refreshing or reloading is necessary.
...
- Switch to the color theme to customize and use the `editor.tokenColorCustomizations` [settings](/md/快速入门/设置.md). Changes are applied live to your VS Code instance and no refreshing or reloading is necessary.
...
![TextMate Scopes](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/TM-scopes.png)
...
You can use the **Developer Tools: Inspect TM Scopes** command from the **Command Palette** (`Ctrl+Shift+P or F1`) to inspect the scopes of a token at the cursor and to see which theming rule has been applied.

![inspect scoped](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/inspect-scopes.png)
...
![yo code theme](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/yocode-colortheme.png)
...
![select my theme](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/mytheme.png)

After making changes to any theme file, it is necessary to reload VS Code with `Reload Window`.

## Publishing a Theme to the Extension Marketplace

If you'd like to share your new theme with the community, you can publish it to the [Extension Marketplace](/md/编辑器/扩展市场.md). Use the [vsce publishing tool](/docs/extensions/publish-extension.md) to package your theme and publish it to the VS Code Marketplace.
...
```json
    "iconDefinitions": {
        "_folder_dark": {
            "iconPath": "./https://code.visualstudio.com/assets/docs/extensions/Folder_16x_inverse.svg"
        }
    }
```
...
Icons can be associated to folders, folder names, files, file extensions, file names and [language ids](/md/扩展API/扩展点.md#_contributeslanguages).
...
You then use the [vsce publishing tool](/docs/extensions/publish-extension.md) to publish the snippet extension to the [VS Code Extension Marketplace](/md/编辑器/扩展市场.md).
...
![yo code language support](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/yocodelanguage.png)
...
For more details check out the [languages contribution point documentation](/md/扩展API/扩展点.md#contributeslanguages).
...
![select ant language](https://code.visualstudio.com/assets/docs/extensions/themes-snippets-colorizers/antlanguage.png)

## Publishing Language Support to the Extension Marketplace

If you'd like to share your new language with the community, you can publish it to the [Extension Marketplace](/md/编辑器/扩展市场.md). Use the [vsce publishing tool](/docs/extensions/publish-extension.md) to package your extension and publish it to the VS Code Marketplace.
...
You can find a list of known language identifiers in the [language identifier reference](/md/语言/identifiers.md).
...
**A:** Yes. To extend an existing colorizer, you can associate a file extension to an existing language identifier with the `files.associations` [setting](/md/快速入门/设置.md).  IntelliSense will show you the list of currently available language ids.
